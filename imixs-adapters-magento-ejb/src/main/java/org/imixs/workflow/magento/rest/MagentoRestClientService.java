...
@Stateless
@LocalBean
public class MagentoRestClientService {
	...
	@EJB
	public PropertyService propertyService = null;
	...
	private static Logger logger = Logger.getLogger(MagentoRestClientService.class
			.getName());
